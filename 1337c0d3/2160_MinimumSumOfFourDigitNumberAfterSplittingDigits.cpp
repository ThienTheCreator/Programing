...
public:
    int minimumSum(int num) {
        ...
        cout << tempNum;
        return ((tempNum[0] - '0') + (tempNum[1] - '0')) * 10 + (tempNum[2] - '0') + (tempNum[3] - '0');
    }
};

/* Note

I first implemented a int vector and got each int individually by looping through it four times.
The better method I saw was to converted it into a string and sort the string then you can use
the index of the string to calculate the result.
