...
I sorted the array first which would be n log n. The better solution I saw loop through the array
and counted the number smaller than the target and the times the target number appeared.
