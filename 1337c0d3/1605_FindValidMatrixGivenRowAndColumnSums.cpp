...
The solution above is from lee215. He gives an explaination the question and gives 2 solutions.
...
Based on the question we can take the min of each rowSum and colSum to get a value for each cell
then we subtract the min from both rowSum and colSum.

The second solution below is the faster solution for c++.
...
The if loops are interesting because they reduce the time a little bit.
