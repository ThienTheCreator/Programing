...
(n - 1, n - 1). You are given the integer n and an integer array startPos where startPos = 
[startrow, startcol] indicates that a robot is initially at cell (startrow, startcol).
...
public:
    vector<int> executeInstructions(int n, vector<int>& startPos, string s) {
        ...
        for(int i = 0; i < s.size(); i++){
            ...
            string tempStr = s.substr(i,s.size()-i);
            int tempRes = 0;
