...
seats[i] is the position of the ith seat. You are also given the array students of length n, where 
...
I implemented a straightforeward solution. I sorted both vectors and return the accumulated 
absolute value of subtracting seats elements with students elements in order. 
