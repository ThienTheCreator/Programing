...
Each row in this table indicates the product's price in 3 different stores: store1, store2, and 
store3.
...
The solution was from mirandanathan. I tried != instead is not null and it did not work. UNION is
use to combine SELECT.
