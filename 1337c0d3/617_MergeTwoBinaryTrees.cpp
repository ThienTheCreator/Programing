...
The solution is similar to the solution by zqfan.
https://leetcode.com/problems/merge-two-binary-trees/discuss/104301/Short-Recursive-Solution-w-Python-and-C%2B%2B

Had trouble solving this one because I had trouble with if conditions for the recursion. It was
easier to check if they existed first then used the nodes. 
