...
move this at the beginning of the permutation P. Notice that the position of queries[i] in P is the
result for queries[i]. Return an array containing the result for the given queries.
...
I just implemented a brute force solution. The most voted solution used a Fenwick tree or binary
index tree. The Fenwick tree is balances element update and calculating prefix sums. Performs both
