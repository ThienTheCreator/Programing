...
I looked at the solution first but I was a ble to solve it using a brute force method with a
vector. There was a pattern to solve it in O(n) time and O(1) space but I was not able to
understand it right now so I have to think about for a bit. 

The optimized solution is from hritesh_bhardwaj:
...
Three solution were proposed in the discussion: brute force, recursion, and optimised solution.
This optimised solution came from the recursive solution.
