...
My solution is similar to the most voted solution. I just kept count of the
number of devies on the previous rows and the number of devices on the current
row. If there are devices on the current row then I would muliply it with
the number on the previous rows and set the number on previous row to the
