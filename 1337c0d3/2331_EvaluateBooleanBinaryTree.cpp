...
This question should have been easy to do, but I spent a bit of time thinking about it.
This question uses if statements to compare the different cases and uses recursion to call itself.
