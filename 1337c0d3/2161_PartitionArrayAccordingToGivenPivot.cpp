...
maintained. More formally, consider every pi, pj where pi is the new position of the ith element 
...
I tried to created the vector again with insert and push_back(), but it exceeded the time limit
so I look at the disscussion and implemented 3 pointers.
