...
Couldn't solve within 20 minutes. Was stuck because of shifting signed and unsigned int. The
solution just checks if the ones value is there and shifts the answer left and the number the
number right.
