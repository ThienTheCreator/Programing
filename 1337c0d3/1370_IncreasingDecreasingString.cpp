...
I had the idea down but instead of using arrays I use a hashmap to keep track of the char and a
vector to delete from the map. Using an array was faster, probably from the push_back and erase
functions.

The solution below is fastest solution and is easier to code compare to my solution. 
