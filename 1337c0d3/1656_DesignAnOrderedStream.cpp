...
I already did this problem when I some time before. I change some of the code
to match the previous solution after I re did the solution. Index is use to add
values when the values can be add consecutively and then we increment it. 
We use a vector to store the values and return a temporary vector. 
