...
moves at speed 2. Then, the fleet (speed 2) and the car starting at 4 (speed 1) become one fleet,
...
Wasn't able to solve. Was trying to figure a way to use a stack with the problem instead of other
methods because it was group under stack. Next time try to solve problem using any method first.
Solution is from lee215:
