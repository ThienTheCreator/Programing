...
I did not have to create a res string, instead I could have replaced all number char with a for
loop that incremented by 2 and added the previous letter to the number and subtract by '0'
