...
This solution took me a while to come up with. I remember that there was a way to count the one by
subtraction somehow. This solution just removes the ones furthest right one each time.
