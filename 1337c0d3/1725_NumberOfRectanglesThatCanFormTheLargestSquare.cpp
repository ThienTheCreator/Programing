...
Loop through array keeping track of two int. The largest number and the count of times it appears.
When there is a number larger then the largest number set the number to the largest number and set
the count to 1.
