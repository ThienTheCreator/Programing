...
Solution uses a helper function to find if the root is equal to the subtree. It makes a recursive
call to to the left and right child if the root is not NULL.
