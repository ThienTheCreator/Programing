...
10111, etc. Given two integers start and goal, return the minimum number of bit flips to convert
start to goal.
...
Output: 3
Explanation: The binary representation of 10 and 7 are 1010 and 0111 respectively. We can convert
10 to 7 in 3 steps:
...
This one is classify as easy. For this one you just have compare if the last bits are equal to each
other, if not then increment your answer. Then you shift both one to the right which basically
divides it by 2.
