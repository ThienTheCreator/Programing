...
The solution involve pairing two int for the priority queue. The first int is the euclidean
distance but without taking the square root. The second int is the index of the coordinates for x
and y. If the size of the pq is greater than k than pop.
