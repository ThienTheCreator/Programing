...
0 and ends at the index of the first occurrence of ch (inclusive). If the character ch does not
...
Some solutions I looked at use reverse instead of for loops. There was also substr.
